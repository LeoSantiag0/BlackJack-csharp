    ...
    public partial class Form_jogo : Form
    {
        ...
        public void resultado()
        {
            ...
            if (pontos_A > pontos_B && pontos_A < 21)
                ...
                lbl_Resultado.Text = "A Mesa ganhou!";
            else
                if (pontos_A < 21 && pontos_B > 21)
                lbl_Resultado.Text = "A Mesa ultrapassou 21, você Ganhou!";
            else
                if (pontos_A == pontos_B)
                lbl_Resultado.Text = "Empate!!!";
            else
                if (pontos_A == 21 && pontos_B > 21)
                lbl_Resultado.Text = "Blackjack!!! Você ganhou com 21";
            else
                if (pontos_A == 21 && pontos_B < 21)
                lbl_Resultado.Text = "Blackjack!!! Você ganhou com 21";
            else
            ...
            private void button1_Click(object sender, EventArgs e)
        {
            ...
            {   // JOGANDO
                ...
                btn_reiniciar.Enabled = true;
                lbl_Resultado.Text = "Você ultrapassou 21, a Mesa ganhou!";
                }
            else
            {   // PARTIDA PERDIDA
                lbl_Pontos_A.Text = Convert.ToString(pontos_A);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            pictureBox1.Image = Properties.Resources.fundoCarta;
            pictureBox2.Image = Properties.Resources.dealer;
